...
<template>
    <div class="login-form">
        <BaseForm>
            <UsernameInput ref="userInput" />
            <EmailInput ref="emailInput" />
            <PasswordInput ref="passwordInput" />
            <PasswordConfirmInput ref="passwordConfirmInput" />
            <BaseButton class="button"
            @click="login" t="submit">Registrer deg!</BaseButton>
...
import PasswordConfirmInput from './PasswordConfirmInput.vue';
